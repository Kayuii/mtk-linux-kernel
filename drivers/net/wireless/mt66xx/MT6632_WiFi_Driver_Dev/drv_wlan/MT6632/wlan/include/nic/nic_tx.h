...
VOID nicTxInterruptSanityCheck(IN P_ADAPTER_T prAdapter, IN PUINT_16 au2TxRlsCnt);
...
#if 0				/* defined(_HIF_USB) */
VOID nicTxUSBCancelSendingCmd(IN P_ADAPTER_T prAdapter, IN P_CMD_INFO_T prCmdInfo);
WLAN_STATUS nicTxUSBSendCmd(IN P_ADAPTER_T prAdapter, IN UINT_16 OutEp, IN P_CMD_INFO_T prCmdInfo, IN UINT_32 u4Length);
VOID nicTxUSBSendCmdComplete(struct urb *urb);
BOOLEAN nicTxUSBIsDataBufEnough(IN P_ADAPTER_T prAdapter, IN UINT_8 ucTc, IN UINT_32 u4Length);
WLAN_STATUS nicTxUSBSendData(IN P_ADAPTER_T prAdapter, IN UINT_8 ucTc, IN UINT_8 *pucBuf, IN UINT_32 u4Length);
VOID nicTxUSBSendDataComplete(struct urb *urb);
#endif
