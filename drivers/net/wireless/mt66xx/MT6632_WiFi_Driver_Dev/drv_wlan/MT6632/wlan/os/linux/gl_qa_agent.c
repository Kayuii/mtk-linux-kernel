			   ...
			   IN union iwreq_data *prIwReqData, INT_32 i4Length, INT_32 i4Status)
{
	...
	if (copy_to_user(prIwReqData->data.pointer, (UCHAR *) (HqaCmdFrame), prIwReqData->data.length)) {
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT copy_to_user() fail in %s\n", __func__);
		return (-EFAULT);
	}
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA command(0x%04x)[Magic number(0x%08x)] is done\n",
...
static INT_32 ToDoFunction(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT ToDoFunction\n");
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_OpenAdapter\n");
			       ...
			       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_CloseAdapter\n");
...
static INT_32 HQA_StartTx(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_StartTx\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (TxCount) = %d\n", TxCount);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (TxLength) = %d\n", TxLength);
...
static INT_32 HQA_StartTxExt(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_StartTxExt\n");
				 ...
				 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_StartTxContiTx\n");
				 ...
				 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_StartTxCarrier\n");
...
static INT_32 HQA_StartRx(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_StartRx\n");
...
static INT_32 HQA_StopTx(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_StopTx\n");
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_StopContiTx\n");
				...
				IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_StopTxCarrier\n");
...
static INT_32 HQA_StopRx(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_StopRx\n");
...
static INT_32 HQA_SetTxPath(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetTxPath\n");
...
/*	INT_16 Value = 0;
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetRxPath\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetRxPath Value : %d\n", Value);
...
static INT_32 HQA_SetTxIPG(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetTxIPG\n");

	memcpy(&u4Aifs, HqaCmdFrame->Data + 4 * 0, 4);
	u4Aifs = ntohs(u4Aifs);

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetTxIPG u4Aifs : %d\n", u4Aifs);
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetTxPower0\n");
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HAQ_SetTxPower1\n");
				...
				IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetTxPowerExt\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetTxPowerExt u4Power : %d\n", u4Power);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetTxPowerExt u4Dbdc_idx : %d\n", u4Dbdc_idx);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetTxPowerExt u4Channel : %d\n", u4Channel);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetTxPowerExt u4Band_idx : %d\n", u4Band_idx);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetTxPowerExt u4Ant_idx : %d\n", u4Ant_idx);
...
static INT_32 HQA_SetOnOff(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetOnOff\n");
...
static INT_32 HQA_AntennaSel(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_AntennaSel\n");
						 ...
						 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_FWPacketCMD_ClockSwitchDisable\n");
...
static INT_32 HQA_SetChannel(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetChannel\n");

	memcpy((PUCHAR) & i4SetChan, HqaCmdFrame->Data, 4);
	i4SetChan = ntohl(i4SetChan);

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (Channel) = %d\n", i4SetChan);
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetPreamble\n");

	memcpy((PUCHAR) & i4Mode, HqaCmdFrame->Data, 4);
	i4Mode = ntohl(i4Mode);

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (Mode) = %d\n", i4Mode);
...
/*	INT_32 i4Value = 0; */
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetRate\n");
...
static INT_32 HQA_SetNss(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetNss\n");
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetSystemBW\n");

	memcpy((PUCHAR) & i4BW, HqaCmdFrame->Data, 4);
	i4BW = ntohl(i4BW);

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (BW) = %d\n", i4BW);
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetPerPktBW\n");

	memcpy((PUCHAR) & u4Perpkt_bw, HqaCmdFrame->Data, 4);
	u4Perpkt_bw = ntohl(u4Perpkt_bw);

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (u4Perpkt_bw) = %d\n", u4Perpkt_bw);
			       ...
			       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetPrimaryBW\n");

	memcpy(&u4Pri_sel, HqaCmdFrame->Data, 4);
	u4Pri_sel = ntohl(u4Pri_sel);

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetPrimaryBW u4Pri_sel : %d\n", u4Pri_sel);
				...
				IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetFreqOffset\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetFreqOffset u4FreqOffset : %d\n", u4FreqOffset);
				   ...
				   IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetAutoResponder\n");
			       ...
			       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetTssiOnOff\n");
						      ...
						      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetRxHighLowTemperatureCompensation\n");
...
static INT_32 HQA_LowPower(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_LowPower\n");
				   ...
				   IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_ResetTxRxCounter\n");
				...
				IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetStatistics\n");
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetRxOKData\n");
			       ...
			       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetRxOKOther\n");
				   ...
				   IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetRxAllPktCount\n");
				   ...
				   IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetTxTransmitted\n");
			       ...
			       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetHwCounter\n");
				       ...
				       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_CalibrationOperation\n");
				       ...
				       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_CalibrationBypassExt\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_CalibrationBypassExt u4Item : 0x%08x\n", u4Item);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_CalibrationBypassExt u4Band_idx : %d\n", u4Band_idx);
				 ...
				 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetRXVectorIdx\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetRXVectorIdx band_idx : %d\n", band_idx);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetRXVectorIdx Group_1 : %d\n", Group_1);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetRXVectorIdx Group_2 : %d\n", Group_2);
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetRXVectorIdx rRfATInfo.u4FuncData : 0x%08x\n",
				  ...
				  IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetFAGCRssiPath\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetFAGCRssiPath u4band_idx : %d\n", u4band_idx);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetFAGCRssiPath u4FAGC_Path : %d\n", u4FAGC_Path);
				...
				IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MacBbpRegRead\n");

	memcpy(&u4Offset, HqaCmdFrame->Data, 4);
	u4Offset = ntohl(u4Offset);

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (Offset) = 0x%08lx\n", u4Offset);
	...
	if (i4Status == 0) {
		...
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT Address = 0x%08lx, Result = 0x%08lx\n", u4Offset, u4Value);
...
/*	INT_32 i4Ret = 0; */
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MacBbpRegWrite\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (Offset) = 0x%08lx\n", u4Offset);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (Value) = 0x%08lx\n", u4Value);
				    ...
				    IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MACBbpRegBulkRead\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (Offset) = 0x%08lx\n", u4Offset);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (Len) = 0x%08lx\n", u2Len);
				...
				IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_RfRegBulkRead\n");
	...
	u4Offset = ntohl(u4Offset);
	u4Offset = u4Offset | 0x99990000;

	memcpy(&u4Length, HqaCmdFrame->Data + 8, 4);
	u4Length = ntohl(u4Length);

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (WfSel)  = %d\n", u4WfSel);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (Offset) = 0x%08lx\n", u4Offset);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (Length) = %d\n", u4Length);

	for (u4Index = 0; u4Index < u4Length; u4Index++) {
		rMcrInfo.u4McrOffset = u4Offset + u4Index * 4;
		rMcrInfo.u4McrData = 0;
		rMcrInfo.ucMcrAntIdx = u4WfSel;
		prGlueInfo = *((P_GLUE_INFO_T *) netdev_priv(prNetDev));
				 ...
				 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_RfRegBulkWrite\n");
				  ...
				  IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_WriteBulkEEPROM Offset : %d\n", Offset);
	...
	if (Len == 2) {
		...
		if (!g_BufferDownload) {
			...
			for (j = 0 ; j < 16 ; j++) {
				...
				rSetEfuseBufModeInfo.aBinContent[j] = uacEEPROMImage[u2InitAddr];
				u2InitAddr += 1;
			}
				 ...
				 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_CheckEfuseMode\n");
				  ...
				  IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetEfuseBlockNr\n");
				       ...
				       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_WriteEFuseFromBuffer\n");
...
/*	UINT_32 u4EfuseAddr = 0, u4Power = 0; */
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetTxPower\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetTxPower u4Channel : %d\n", u4Channel);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetTxPower u4Band : %d\n", u4Band);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetTxPower u4Ch_Band : %d\n", u4Ch_Band);
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetCfgOnOff\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetCfgOnOff Type : %d\n", Type);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetCfgOnOff Enable : %d\n", Enable);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetCfgOnOff Band : %d\n", Band);
				...
				IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetFreqOffset\n");
	...
	if (i4Ret == 0) {
		...
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetFreqOffset u4FreqOffset = %d\n", u4FreqOffset);
...
static INT_32 HQA_DBDCTXTone(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DBDCTXTone\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (i4BandIdx) = 0x%08lx\n", i4BandIdx);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (i4Control) = 0x%08lx\n", i4Control);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (i4AntIndex) = 0x%08lx\n", i4AntIndex);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (i4ToneType) = 0x%08lx\n", i4ToneType);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (i4ToneFreq) = 0x%08lx\n", i4ToneFreq);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (i4DcOffsetI) = 0x%08lx\n", i4DcOffsetI);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (i4DcOffsetQ) = 0x%08lx\n", i4DcOffsetQ);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (i4Band) = 0x%08lx\n", i4Band);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (i4RF_Power) = 0x%08lx\n", i4RF_Power);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (i4Digi_Power) = 0x%08lx\n", i4Digi_Power);
				   ...
				   IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DBDCContinuousTX\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DBDCContinuousTX u4Band : %d\n", u4Band);	/* ok */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DBDCContinuousTX u4Control : %d\n", u4Control);	/* ok */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DBDCContinuousTX u4AntMask : %d\n", u4AntMask);	/* ok */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DBDCContinuousTX u4Phymode : %d\n", u4Phymode);	/* ok */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DBDCContinuousTX u4BW : %d\n", u4BW);	/* ok */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DBDCContinuousTX u4Pri_Ch : %d\n", u4Pri_Ch);	/* ok */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DBDCContinuousTX u4Rate : %d\n", u4Rate);	/* ok */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DBDCContinuousTX u4Central_Ch : %d\n", u4Central_Ch);	/* ok */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DBDCContinuousTX u4TxfdMode : %d\n", u4TxfdMode);	/* ok */
	...
	if (u4Control) {
		...
		if (u4Phymode == 0) {
			...
			DBGLOG(INIT, INFO, "MT6632 : QA_AGENT CCK/OFDM (normal preamble) rate : %d\n", u4Rate);
			...
			DBGLOG(INIT, INFO, "MT6632 : QA_AGENT CCK (short preamble) rate : %d\n", u4Rate);

			MT_ATESetRate(prNetDev, u4Rate);
		} else if (u4Phymode >= 2 && u4Phymode <= 4) {
			u4Rate |= 0x80000000;

			DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HT/VHT rate : %d\n", u4Rate);
				    ...
				    IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetRXFilterPktLen\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetRXFilterPktLen Band : %d\n", u4Band);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetRXFilterPktLen Control : %d\n", u4Control);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetRXFilterPktLen RxPktlen : %d\n", u4RxPktlen);
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetRXFilterPktLen rRfATInfo.u4FuncData : 0x%08x\n",
	       rRfATInfo.u4FuncData);
...
static INT_32 HQA_GetTXInfo(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetTXInfo\n");
	...
	if (i4Status == 0) {
		...
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT u4Txed_band0 packet count = %d\n", u4Txed_band0);
	...
	if (i4Status == 0) {
		...
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT u4Txed_band1 packet count = %d\n", u4Txed_band1);
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetCfgOnOff\n");
					 ...
					 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_ReadTempReferenceValue\n");
				  ...
				  IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetThermalValue\n");
	...
	if (i4Status == 0) {
		...
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT Thermal Value = %d\n", u4Value);
				    ...
				    IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetSideBandOption\n");
...
static INT_32 HQA_GetFWInfo(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetFWInfo\n");
				   ...
				   IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_StartContinousTx\n");
...
static INT_32 HQA_SetSTBC(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetSTBC\n");
...
static INT_32 HQA_SetShortGI(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetShortGI\n");

	memcpy(&u4ShortGi, HqaCmdFrame->Data, 4);
	u4ShortGi = ntohl(u4ShortGi);

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetShortGI u4ShortGi = %d\n", u4ShortGi);
...
static INT_32 HQA_SetDPD(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetDPD\n");
				     ...
				     IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetRxStatisticsAll\n");
				   ...
				   IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_StartContiTxTone\n");
				  ...
				  IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_StopContiTxTone\n");
				      ...
				      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_CalibrationTestMode\n");
					...
					IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DoCalibrationTestItem\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_rx_ext item : 0x%08x\n", u4Item);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_rx_ext band_idx : %d\n", u4Band_idx);
				     ...
				     IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_eFusePhysicalWrite\n");
				    ...
				    IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_eFusePhysicalRead\n");
				   ...
				   IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_eFuseLogicalRead\n");
				    ...
				    IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_eFuseLogicalWrite\n");
...
static INT_32 HQA_TMRSetting(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TMRSetting\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TMRSetting u4Setting : %d\n", u4Setting);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TMRSetting u4Version : %d\n", u4Version);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TMRSetting u4MPThres : %d\n", u4MPThres);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TMRSetting u4MPIter : %d\n", u4MPIter);
...
static INT_32 HQA_GetRxSNR(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetRxSNR\n");
...
/*	PARAM_CUSTOM_EFUSE_BUFFER_MODE_T rSetEfuseBufModeInfo; */
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_WriteBufferDone\n");

	memcpy(&Value, HqaCmdFrame->Data + 4 * 0, 4);
	Value = ntohl(Value);

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_WriteBufferDone Value : %d\n", Value);
...
static INT_32 HQA_FFT(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_FFT\n");
				 ...
				 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetTxTonePower\n");
...
/*	P_GLUE_INFO_T prGlueInfo = NULL;
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetChipID\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetChipID ChipId = 0x%08lx\n", ChipId);
				...
				IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetSeqData\n");

	u4Len = ntohs(HqaCmdFrame->Length)/sizeof(UINT_32) - 1;

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetSeqData u4Len : %d\n", u4Len);
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetSeqData u4Band_idx : %d\n", u4Band_idx);
				      ...
				      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetPayloadLength\n");

	u4Len = ntohs(HqaCmdFrame->Length)/sizeof(UINT_32) - 1;

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetPayloadLength u4Len : %d\n", u4Len);
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetPayloadLength u4Band_idx : %d\n", u4Band_idx);
				    ...
				    IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetPacketCount\n");

	u4Len = ntohs(HqaCmdFrame->Length)/sizeof(UINT_32) - 1;

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetPacketCount u4Len : %d\n", u4Len);
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetPacketCount u4Band_idx : %d\n", u4Band_idx);
				  ...
				  IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetPowerGain\n");

	u4Len = ntohs(HqaCmdFrame->Length)/sizeof(UINT_32) - 1;

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetPowerGain u4Len : %d\n", u4Len);
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetPowerGain u4Band_idx : %d\n", u4Band_idx);
	...
	for (i = 0 ; i < u4Len ; i++) {
		...
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetPowerGain mps_setting Case %d (Power : %d)\n",
			i, mps_setting[i]);
	}
...
static INT_32 HQA_MPSStart(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSStart\n");
...
static INT_32 HQA_MPSStop(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSStop\n");
...
static INT_32 HQA_MPSSetNss(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetNss\n");

	u4Len = ntohs(HqaCmdFrame->Length)/sizeof(UINT_32) - 1;

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetNss u4Len : %d\n", u4Len);
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetNss u4Band_idx : %d\n", u4Band_idx);
	...
	for (i = 0; i < u4Len; i++) {
		...
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetNss mps_setting Case %d (Nss : %d)\n",
			i, mps_setting[i]);
	}
	...
	HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetPerpacketBW\n");

	u4Len = ntohs(HqaCmdFrame->Length)/sizeof(UINT_32) - 1;

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetPerpacketBW u4Len : %d\n", u4Len);
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetPerpacketBW u4Band_idx : %d\n", u4Band_idx);
	...
	for (i = 0 ; i < u4Len ; i++) {
		...
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MPSSetPerpacketBW mps_setting Case %d (BW : %d)\n",
			i, mps_setting[i]);
	}
...
static INT_32 HQA_SetAIFS(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetAIFS\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetAIFS SlotTime = %d\n", SlotTime);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetAIFS SifsTime = %d\n", SifsTime);
				     ...
				     IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_CheckEfuseModeType\n");
					   ...
					   IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_CheckEfuseNativeModeType\n");
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetBandMode\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetBandMode u4Band_mode : %d\n", u4Band_mode);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_SetBandMode u4Band_type : %d\n", u4Band_type);
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetBandMode\n");

	memcpy((PUCHAR) & u4Band_idx, HqaCmdFrame->Data, 4);

	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetBandMode u4Band_idx : %d\n", u4Band_idx);
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_GetBandMode g_DBDCEnable = %d\n", g_DBDCEnable);
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_RDDStartExt\n");

	DBGLOG(INIT, INFO, "[RDD DUMP START]\n");
				...
				IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_RDDStopExt\n");

	i4Ret = MT_ATERDDStop(prNetDev, "RDDSTOP");

	DBGLOG(INIT, INFO, "[RDD DUMP END]\n");
				...
				IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_BssInfoUpdate\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_BssInfoUpdate OwnMacIdx : %d\n", OwnMacIdx);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_BssInfoUpdate BssIdx : %d\n", BssIdx);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_BssInfoUpdate addr1:%02x:%02x:%02x:%02x:%02x:%02x\n",
	...
	DBGLOG(INIT, ERROR, "MT6632 prInBuf = %s\n", prInBuf);
				...
				IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DevInfoUpdate\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DevInfoUpdate Band : %d\n", Band);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DevInfoUpdate OwnMacIdx : %d\n", OwnMacIdx);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_DevInfoUpdate addr1:%02x:%02x:%02x:%02x:%02x:%02x\n",
	       ucAddr1[0], ucAddr1[1], ucAddr1[2], ucAddr1[3], ucAddr1[4], ucAddr1[5]);
...
static INT_32 HQA_LogOnOff(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_LogOnOff\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_LogOnOff band_idx : %d\n", u4Band_idx);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_LogOnOff log_type : %d\n", u4Log_type);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_LogOnOff log_ctrl : %d\n", u4Log_ctrl);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_LogOnOff log_size : %d\n", u4Log_size);
					...
					IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagInValid\n");
					...
					IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagPfmuIdx\n");
				       ...
				       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagBfType\n");
				   ...
				   IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagBw\n");
				     ...
				     IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagSuMu\n");
					 ...
					 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagMemAlloc\n");
				       ...
				       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagMatrix\n");
				    ...
				    IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagSnr\n");
				       ...
				       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagSmtAnt\n");
				      ...
				      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagSeIdx\n");
					 ...
					 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagRmsdThrd\n");
					...
					IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagMcsThrd\n");
					...
					IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagTimeOut\n");
					  ...
					  IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagDesiredBw\n");
					  ...
					  IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagDesiredNc\n");
					  ...
					  IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagDesiredNr\n");
				      ...
				      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagWrite\n");
				     ...
				     IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfProfileTagRead\n");
				  ...
				  IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_StaRecCmmUpdate\n");
				 ...
				 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_StaRecBfUpdate\n");
				    ...
				    IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_BFProfileDataRead\n");
				     ...
				     IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_BFProfileDataWrite\n");
...
static INT_32 HQA_BFSounding(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_BFSounding\n");
				   ...
				   IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TXBFSoundingStop\n");
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_TxBfTxApply\n");
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_ManualAssoc\n");
			       ...
			       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MUGetInitMCS\n");
			       ...
			       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MUCalInitMCS\n");
...
static INT_32 HQA_MUCalLQ(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MUCalLQ\n");
...
static INT_32 HQA_MUGetLQ(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MUGetLQ\n");
				 ...
				 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MUSetSNROffset\n");
			       ...
			       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MUSetZeroNss\n");
				 ...
				 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MUSetSpeedUpLQ\n");
			       ...
			       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MUSetMUTable\n");
...
static INT_32 HQA_MUSetGroup(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MUSetGroup\n");
...
static INT_32 HQA_MUGetQD(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MUGetQD\n");
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MUSetEnable\n");
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MUSetGID_UP\n");
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_MUTriggerTx\n");
...
/*	UINT_32 u4TriggerMac = 0; */	/* Temp unused */
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_CapWiFiSpectrum\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (u4Control) = %d\n", u4Control);
	...
	if (u4Control == 1 && u4Trigger == 1) {
		...
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (u4Trigger) = %d\n", u4Trigger);
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (u4RingCapEn) = %d\n", u4RingCapEn);
		/* AT Command #81 */
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (u4TriggerEvent) = %d\n", u4TriggerEvent);
		/* AT Command #80 */
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (u4CaptureNode) = %d\n", u4CaptureNode);
		/* AT Command #83 */
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (u4CaptureLen) = %d\n", u4CaptureLen);
		/* AT Command #84 */
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (u4CapStopCycle) = %d\n", u4CapStopCycle);
		/* AT Command #71 */
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (u4BW) = %d\n", u4BW);
		...
		if (g_bCaptureDone) {
			DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_CapWiFiSpectrum Done!!!!!!!!!!!!!!!!!\n");
			i4Ret = 0;
			/* Query whether ICAP Done */
			ResponseToQA(HqaCmdFrame, prIwReqData, 2, i4Ret);
		} else {
			DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_CapWiFiSpectrum Wait!!!!!!!!!!!!!!!!!\n");
			i4Ret = 1;
			/* Query whether ICAP Done */
			ResponseToQA(HqaCmdFrame, prIwReqData, 2, i4Ret);
		}
		...
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (u4WFNum) = %d\n", u4WFNum);
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HqaCmdFrame->Data (u4IQ) = %d\n", u4IQ);
				  ...
				  IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_channel_ext\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_channel_ext ext_id : %d\n", u4Ext_id);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_channel_ext param_num : %d\n", u4Param_num);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_channel_ext band_idx : %d\n", u4Band_idx);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_channel_ext central_ch0 : %d\n", u4Central_ch0);
	/* for BW80+80 */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_channel_ext central_ch1 : %d\n", u4Central_ch1);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_channel_ext sys_bw : %d\n", u4Sys_bw);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_channel_ext perpkt_bw : %d\n", u4Perpkt_bw);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_channel_ext pri_sel : %d\n", u4Pri_sel);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_channel_ext reason : %d\n", u4Reason);
	/* 0:2.4G    1:5G */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_channel_ext ch_band : %d\n", u4Ch_band);
				    ...
				    IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_txcontent_ext\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_txcontent_ext ext_id : %d\n", u4Ext_id);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_txcontent_ext param_num : %d\n", u4Param_num);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_txcontent_ext band_idx : %d\n", u4Band_idx);
	/* Frame Control...0800 : Beacon */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_txcontent_ext FC : 0x%x\n", u4FC);
	/* Duration....NAV */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_txcontent_ext dur : 0x%x\n", u4Dur);
	/* Sequence Control */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_txcontent_ext seq : 0x%x\n", u4Seq);
	/* Normal:0,Repeat:1,Random:2 */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_txcontent_ext gen_payload_rule : %d\n", u4Gen_payload_rule);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_txcontent_ext txlen : %d\n", u4Txlen);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_txcontent_ext payload_len : %d\n", u4Payload_len);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_txcontent_ext addr1:%02x:%02x:%02x:%02x:%02x:%02x\n",
	       ucAddr1[0], ucAddr1[1], ucAddr1[2], ucAddr1[3], ucAddr1[4], ucAddr1[5]);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_txcontent_ext addr2:%02x:%02x:%02x:%02x:%02x:%02x\n",
	       ucAddr2[0], ucAddr2[1], ucAddr2[2], ucAddr2[3], ucAddr2[4], ucAddr2[5]);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_set_txcontent_ext addr3:%02x:%02x:%02x:%02x:%02x:%02x\n",
	       ucAddr3[0], ucAddr3[1], ucAddr3[2], ucAddr3[3], ucAddr3[4], ucAddr3[5]);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext payload : 0x%x\n", ucPayload);
			       ...
			       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext ext_id : %d\n", u4Ext_id);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext param_num : %d\n", u4Param_num);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext band_idx : %d\n", u4Band_idx);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext pkt_cnt : %d\n", u4Pkt_cnt);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext phymode : %d\n", u4Phymode);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext rate : %d\n", u4Rate);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext pwr : %d\n", u4Pwr);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext stbc : %d\n", u4Stbc);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext ldpc : %d\n", u4Ldpc);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext ibf : %d\n", u4iBF);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext ebf : %d\n", u4eBF);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext wlan_id : %d\n", u4Wlan_id);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext aifs : %d\n", u4Aifs);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext gi : %d\n", u4Gi);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext tx_path : %d\n", u4Tx_path);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_tx_ext nss : %d\n", u4Nss);
			       ...
			       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_rx_ext\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_rx_ext ext_id : %d\n", u4Ext_id);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_rx_ext param_num : %d\n", u4Param_num);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_rx_ext band_idx : %d\n", u4Band_idx);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_rx_ext own_mac:%02x:%02x:%02x:%02x:%02x:%02x\n",
	       ucOwn_mac[0], ucOwn_mac[1], ucOwn_mac[2], ucOwn_mac[3], ucOwn_mac[4], ucOwn_mac[5]);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_start_rx_ext rx_path : 0x%x\n", u4Rx_path);
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_stop_tx_ext\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_stop_tx_ext ext_id : %d\n", u4Ext_id);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_stop_tx_ext param_num : %d\n", u4Param_num);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_stop_tx_ext band_idx : %d\n", u4Band_idx);
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_stop_rx_ext\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_stop_rx_ext ext_id : %d\n", u4Ext_id);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_stop_rx_ext param_num : %d\n", u4Param_num);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_stop_rx_ext band_idx : %d\n", u4Band_idx);
...
static INT_32 HQA_iBFInit(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_iBFInit\n");
			      ...
			      IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_iBFSetValue\n");
			       ...
			       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_iBFGetStatus\n");
				    ...
				    IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_iBFChanProfUpdate\n");
				 ...
				 IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_iBFProfileRead\n");
...
static INT_32 HQA_IRRSetADC(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetADC\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetADC ext_id : %d\n", u4Ext_id);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetADC u4WFIdx : %d\n", u4WFIdx);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetADC u4ChFreq : %d\n", u4ChFreq);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetADC u4BW : %d\n", u4BW);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetADC u4Sx : %d\n", u4Sx);	/* SX : 0, 2 */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetADC u4Band : %d\n", u4Band);
	/* RunType : 0 -> QA, 1 -> ATE */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetADC u4RunType : %d\n", u4RunType);
	/* FType : 0 -> FI, 1 -> FD */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetADC u4FType : %d\n", u4FType);
			       ...
			       IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetRxGain\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetRxGain ext_id : %d\n", u4Ext_id);
	/* PGA is for MT663, LPFG is for MT7615 */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetRxGain u4PgaLpfg : %d\n", u4PgaLpfg);
	/* 5 : UH, 4 : H, 3 : M, 2 : L, 1 : UL */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetRxGain u4Lna : %d\n", u4Lna);
	/* DBDC band0 or band1 */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetRxGain u4Band : %d\n", u4Band);
	/* (each bit for each WF) */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetRxGain u4WF_inx : 0x%x\n", u4WF_inx);
	/* only for MT6632 */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetRxGain u4Rfdgc : %d\n", u4Rfdgc);
...
static INT_32 HQA_IRRSetTTG(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetTTG\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetTTG ext_id : %d\n", u4Ext_id);
	/* TTG Power Index:   Power index value 0~15 */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetTTG u4TTGPwrIdx : %d\n", u4TTGPwrIdx);
	/* Ch Freq: channel frequency value */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetTTG u4ChFreq : %d\n", u4ChFreq);
	/* FI Tone Freq(float): driver calculate TTG Freq(TTG Freq = Ch_freq + FI tone freq) */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetTTG u4FIToneFreq : %d\n", u4FIToneFreq);
	/* Band: DBDC band0 or band1 */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetTTG u4Band : %d\n", u4Band);
				  ...
				  IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetTrunOnTTG\n");
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetTrunOnTTG ext_id : %d\n", u4Ext_id);
	/* TTG on/off:  0:off,   1: on */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetTrunOnTTG u4TTGOnOff : %d\n", u4TTGOnOff);
	/* Band: DBDC band0 or band1 */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetTrunOnTTG u4Band : %d\n", u4Band);
	/* (each bit for each WF) */
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT HQA_IRRSetTrunOnTTG u4WF_inx : %d\n", u4WF_inx);
...
static INT_32 hqa_ext_cmds(struct net_device *prNetDev, IN union iwreq_data *prIwReqData, HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_ext_cmds index : %d\n", i4Idx);

	if (hqa_ext_cmd_set[i4Idx] != NULL)
		i4Ret = (*hqa_ext_cmd_set[i4Idx]) (prNetDev, prIwReqData, HqaCmdFrame);
	else
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT hqa_ext_cmds cmd idx %d is not supported : %d\n", i4Idx);
		  ...
		  IN struct iw_request_info *prIwReqInfo, IN union iwreq_data *prIwReqData, IN char *pcExtra)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT priv_qa_agent : HqaCmdFrame->MagicNo = 0x%08lx\n", u4ATEMagicNum);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT priv_qa_agent : HqaCmdFrame->Id = 0x%08lx\n", u4ATEId);
	DBGLOG(INIT, INFO, "MT6632 : QA_AGENT priv_qa_agent : HqaCmdFrame->Data = 0x%08lx\n", u4ATEData);
	...
	default:
		i4Status = -EINVAL;
		DBGLOG(INIT, INFO, "MT6632 : QA_AGENT ATEMagicNum Error!!!\n");
		break;
	}
