...
#define EFUSE_CONTENT_BUFFER_START        0x0F0
#define EFUSE_CONTENT_BUFFER_END          0x43F
#define EFUSE_CONTENT_SIZE			      (EFUSE_CONTENT_BUFFER_END - EFUSE_CONTENT_BUFFER_START + 1)
#else
...
typedef struct _PARAM_CUSTOM_MCR_RW_STRUCT_T {
	...
	UINT_8 ucMcrAntIdx;	/* PeiHsuan 6632 : CR Read / Write with Antenna Idx */
	UINT_8 ucMcrReserved[3];	/* PeiHsuan 6632 : CR Read / Write with Antenna Idx */
