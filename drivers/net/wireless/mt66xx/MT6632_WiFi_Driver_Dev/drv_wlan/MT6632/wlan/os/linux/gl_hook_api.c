...
INT_32 MT_ATEStart(struct net_device *prNetDev, UINT_8 *prInBuf)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK SetATE = %s\n", prInBuf);
...
INT_32 MT_ATESetChannel(struct net_device *prNetDev, UINT_32 u4SXIdx, UINT_32 u4SetFreq)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK SetChannel=%d, Freq=%d\n", i4SetChan, u4SetFreq);
...
INT_32 MT_ATESetPreamble(struct net_device *prNetDev, UINT_32 u4Mode)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK SetPreamble=%d\n", u4Mode);
...
INT_32 MT_ATESetSystemBW(struct net_device *prNetDev, UINT_32 u4BW)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK SetSystemBW=%d\n", u4BW);
...
INT_32 MT_ATESetTxLength(struct net_device *prNetDev, UINT_32 u4TxLength)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK SetTxLength=%d\n", u4TxLength);
...
INT_32 MT_ATESetTxCount(struct net_device *prNetDev, UINT_32 u4TxCount)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK SetTxCount=%d\n", u4TxCount);
...
INT_32 MT_ATESetTxIPG(struct net_device *prNetDev, UINT_32 u4TxIPG)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK SetTxIPG=%d\n", u4TxIPG);
...
INT_32 MT_ATESetTxPower0(struct net_device *prNetDev, UINT_32 u4TxPower0)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK SetTxPower0=0x%02x\n", u4TxPower0);

	if (u4TxPower0 > 0x3F) {
		u4TxPower0 += 128;
		DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK Negative Power =0x%02x\n", u4TxPower0);
	}
...
INT_32 MT_ATESetPerPacketBW(struct net_device *prNetDev, UINT_32 u4BW)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK SetPerPacketBW=%d\n", u4BW);
...
INT_32 MT_ATEPrimarySetting(struct net_device *prNetDev, UINT_32 u4PrimaryCh)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK PrimarySetting=%d\n", u4PrimaryCh);
...
INT_32 MT_ATESetTxGi(struct net_device *prNetDev, UINT_32 u4SetTxGi)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK SetTxGi=%d\n", u4SetTxGi);
...
INT_32 MT_ATESetTxPath(struct net_device *prNetDev, UINT_32 u4Tx_path)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK u4Tx_path=%d\n", u4Tx_path);
...
INT_32 MT_ATESetTxPayLoad(struct net_device *prNetDev, UINT_32 u4Gen_payload_rule, UINT_8 ucPayload)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK rule=%d, len =0x%x\n", u4Gen_payload_rule, ucPayload);
...
INT_32 MT_ATESetTxSTBC(struct net_device *prNetDev, UINT_32 u4Stbc)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK u4Stbc=%d\n", u4Stbc);
...
INT_32 MT_ATESetTxVhtNss(struct net_device *prNetDev, UINT_32 u4VhtNss)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK u4Nss=%d\n", u4VhtNss);
...
INT_32 MT_ATESetRate(struct net_device *prNetDev, UINT_32 u4Rate)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK SetRate=0x%08lx\n", u4Rate);
...
INT_32 MT_ATESetEncodeMode(struct net_device *prNetDev, UINT_32 u4Ldpc)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK SetEncodeMode=%d\n", u4Ldpc);
...
INT_32 MT_ATESetiBFEnable(struct net_device *prNetDev, UINT_32 u4iBF)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK SetiBFEnable=%d\n", u4iBF);
...
INT_32 MT_ATESeteBFEnable(struct net_device *prNetDev, UINT_32 u4eBF)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK SeteBFEnable=%d\n", u4eBF);
...
INT_32 MT_ATESetMACAddress(struct net_device *prNetDev, UINT_32 u4Type, PUINT_8 ucAddr)
{
	...
	DBGLOG(INIT, ERROR, "MT6632 : QA_ATE_HOOK SetMACAddress Type = %d, Addr = %02x:%02x:%02x:%02x:%02x:%02x\n",
...
INT_32 MT_ATELogOnOff(struct net_device *prNetDev, UINT_32 u4Type, UINT_32 u4On_off, UINT_32 u4Size)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATELogOnOff\n");

	switch (u4Type) {
	case ATE_LOG_RXV:
		DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATELogOnOff : ATE_LOG_RXV\n\n");
		break;
	case ATE_LOG_RDD:
		DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATELogOnOff : ATE_LOG_RDD\n\n");
		break;
	case ATE_LOG_RE_CAL:
		DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATELogOnOff : ATE_LOG_RE_CAL\n\n");
		break;
	case ATE_LOG_RXINFO:
		DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATELogOnOff : ATE_LOG_RXINFO\n\n");
		break;
	case ATE_LOG_TXDUMP:
		DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATELogOnOff : ATE_LOG_TXDUMP\n\n");
		break;
	case ATE_LOG_TEST:
		DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATELogOnOff : ATE_LOG_TEST\n\n");
		break;
	default:
		DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK log type %d not supported\n\n", u4Type);
	}

#if 0
	if (u4On_off == ATE_LOG_DUMP) {
		if (u4Type == ATE_LOG_RXV) {
			DBGLOG(INIT, ERROR, "[LOG DUMP START]\n");
			DBGLOG(INIT, ERROR, "\%[RXV DUMP START][0]\n");

			DBGLOG(INIT, ERROR, "[RXVD1]00f20000\n");
			DBGLOG(INIT, ERROR, "[RXVD2]400000eb\n");
			DBGLOG(INIT, ERROR, "[RXVD3]ae9ec000\n");
			DBGLOG(INIT, ERROR, "[RXVD4]2e3d4017\n");
			DBGLOG(INIT, ERROR, "[RXVD5]31fbe6ff\n");
			DBGLOG(INIT, ERROR, "[RXVD6]454a5136\n");
			DBGLOG(INIT, ERROR, "[RXVD7]50000740\n");
			DBGLOG(INIT, ERROR, "[RXVD8]ae9e000c\n");
			DBGLOG(INIT, ERROR, "[RXVD9]ae9e000c\n");

			DBGLOG(INIT, ERROR, "[RXV DUMP END]\n");
			DBGLOG(INIT, ERROR, "\%[RXV DUMP START][1]\n");

			DBGLOG(INIT, ERROR, "[RXVD1]00f20000\n");
			DBGLOG(INIT, ERROR, "[RXVD2]400000eb\n");
			DBGLOG(INIT, ERROR, "[RXVD3]ae9ec000\n");
			DBGLOG(INIT, ERROR, "[RXVD4]2d3d3f16\n");
			DBGLOG(INIT, ERROR, "[RXVD5]321fe77f\n");
			DBGLOG(INIT, ERROR, "[RXVD6]454a5136\n");
			DBGLOG(INIT, ERROR, "[RXVD7]500007f0\n");
			DBGLOG(INIT, ERROR, "[RXVD8]ae9e000c\n");
			DBGLOG(INIT, ERROR, "[RXVD9]ae9e000c\n");

			DBGLOG(INIT, ERROR, "[RXV DUMP END]\n");
			DBGLOG(INIT, ERROR, "\%[RXV DUMP START][2]\n");
			...
			DBGLOG(INIT, ERROR, "[RXV DUMP END]\n");
			DBGLOG(INIT, ERROR, "\%[RXV DUMP START][3]\n");
			...
			DBGLOG(INIT, ERROR, "[RXV DUMP END]\n");
			DBGLOG(INIT, ERROR, "\%[RXV DUMP START][4]\n");
			...
			DBGLOG(INIT, ERROR, "[RXV DUMP END]\n");
			DBGLOG(INIT, ERROR, "\%[RXV DUMP START][5]\n");
			...
			DBGLOG(INIT, ERROR, "[RXV DUMP END]\n");
			DBGLOG(INIT, ERROR, "\%[RXV DUMP START][6]\n");
			...
			DBGLOG(INIT, ERROR, "[RXV DUMP END]\n");
			DBGLOG(INIT, ERROR, "\%[RXV DUMP START][7]\n");
			...
			DBGLOG(INIT, ERROR, "[RXV DUMP END]\n");
			DBGLOG(INIT, ERROR, "[LOG DUMP END]\n");
		}
	}
#else
	...
	if ((u4On_off == ATE_LOG_DUMP) && (u4Type == ATE_LOG_RXV)) {
		...
		if (i4Status == 0) {
			...
			DBGLOG(INIT, ERROR, "MT6632 : QA_ATE_HOOK Get RX Vector Total size = %d\n", i4RXVLength);
		} else {
			DBGLOG(INIT, ERROR, "MT6632 : QA_ATE_HOOK Get RX Vector Total Size Error!!!!\n\n");
		}

		TOOL_PRINTLOG(INIT, ERROR, "[LOG DUMP START]\n");
		...
		for (i = 0; i < i4TargetLength; i += 4) {
			...
			if (i4Status == 0) {
				...
				if (i % 36 == 0)
					TOOL_PRINTLOG(INIT, ERROR, "\%[RXV DUMP START][%d]\n", (i / 36) + 1);

				TOOL_PRINTLOG(INIT, ERROR, "[RXVD%d]%08x\n", ((i % 36) / 4) + 1, rxv);

				if (((i % 36) / 4) + 1 == 9)
					TOOL_PRINTLOG(INIT, ERROR, "[RXV DUMP END]\n");
			}
		}

		TOOL_PRINTLOG(INIT, ERROR, "[LOG DUMP END]\n");
	}
#endif
...
INT_32 MT_ATEResetTXRXCounter(struct net_device *prNetDev)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATEResetTXRXCounter\n");
...
INT_32 MT_ATESetDBDCBandIndex(struct net_device *prNetDev, UINT_32 u4BandIdx)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATESetDBDCBandIndex\n");
...
INT_32 MT_ATESetBand(struct net_device *prNetDev, INT_32 i4Band)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATESetBand\n");
...
INT_32 MT_ATESetTxToneType(struct net_device *prNetDev, INT_32 i4ToneType)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATESetTxToneType\n");
...
INT_32 MT_ATESetTxToneBW(struct net_device *prNetDev, INT_32 i4ToneFreq)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATESetTxToneBW\n");
...
INT_32 MT_ATESetTxToneDCOffset(struct net_device *prNetDev, INT_32 i4DcOffsetI, INT_32 i4DcOffsetQ)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATESetTxToneDCOffset\n");
...
INT_32 MT_ATESetDBDCTxTonePower(struct net_device *prNetDev, INT_32 i4AntIndex, INT_32 i4RF_Power, INT_32 i4Digi_Power)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATESetDBDCTxTonePower\n");
...
INT_32 MT_ATEDBDCTxTone(struct net_device *prNetDev, INT_32 i4Control)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATEDBDCTxTone\n");
...
INT_32 MT_ATESetMacHeader(struct net_device *prNetDev, UINT_32 u4FrameCtrl, UINT_32 u4DurationID, UINT_32 u4SeqCtrl)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATESetMacHeader\n");
			...
			UINT_32 u4BW, UINT_32 u4Sx, UINT_32 u4Band, UINT_32 u4RunType, UINT_32 u4FType)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATE_IRRSetADC\n");
			   ...
			   UINT_32 u4PgaLpfg, UINT_32 u4Lna, UINT_32 u4Band, UINT_32 u4WF_inx, UINT_32 u4Rfdgc)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATE_IRRSetRxGain\n");
			...
			UINT_32 u4TTGPwrIdx, UINT_32 u4ChFreq, UINT_32 u4FIToneFreq, UINT_32 u4Band)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATE_IRRSetTTG\n");
...
INT_32 MT_ATE_IRRSetTrunOnTTG(struct net_device *prNetDev, UINT_32 u4TTGOnOff, UINT_32 u4Band, UINT_32 u4WF_inx)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATE_IRRSetTrunOnTTG\n");
			 ...
			 UINT_32 u4Setting, UINT_32 u4Version, UINT_32 u4MPThres, UINT_32 u4MPIter)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATE_TMRSetting\n");
			...
			UINT_32 u4TestNum, UINT_32 *pu4Phy, UINT_32 u4Band)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATEMPSSetSeqData\n");
			...
			UINT_32 u4TestNum, UINT_32 *pu4Length, UINT_32 u4Band)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATEMPSSetPayloadLength\n");
			...
			UINT_32 u4TestNum, UINT_32 *pu4PktCnt, UINT_32 u4Band)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATEMPSSetPacketCount\n");
			...
			UINT_32 u4TestNum, UINT_32 *pu4PwrGain, UINT_32 u4Band)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATEMPSSetPowerGain\n");
			...
			UINT_32 u4TestNum, UINT_32 *pu4Nss, UINT_32 u4Band)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATEMPSSetNss\n");
			...
			UINT_32 u4TestNum, UINT_32 *pu4PerPktBW, UINT_32 u4Band)
{
	...
	DBGLOG(INIT, INFO, "MT6632 : QA_ATE_HOOK MT_ATEMPSSetPerpacketBW\n");
			   ...
			   P_PFMU_PROFILE_TAG1 prPfmuTag1, P_PFMU_PROFILE_TAG2 prPfmuTag2, UINT_8 profileIdx)
{
	...
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : au4RawData[0] = 0x%08x\n", prPfmuTag1->au4RawData[0]);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : au4RawData[1] = 0x%08x\n", prPfmuTag1->au4RawData[1]);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : au4RawData[2] = 0x%08x\n", prPfmuTag1->au4RawData[2]);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : au4RawData[3] = 0x%08x\n", prPfmuTag1->au4RawData[3]);

	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag2 : au4RawData[0] = 0x%08x\n", prPfmuTag2->au4RawData[0]);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag2 : au4RawData[1] = 0x%08x\n", prPfmuTag2->au4RawData[1]);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag2 : au4RawData[2] = 0x%08x\n", prPfmuTag2->au4RawData[2]);

	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucProfileID= %d\n", prPfmuTag1->rField.ucProfileID);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucTxBf= %d\n", prPfmuTag1->rField.ucTxBf);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucDBW= %d\n", prPfmuTag1->rField.ucDBW);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucSU_MU= %d\n", prPfmuTag1->rField.ucSU_MU);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucInvalidProf= %d\n",
	       prPfmuTag1->rField.ucInvalidProf);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucRMSD= %d\n", prPfmuTag1->rField.ucRMSD);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucMemAddr1ColIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr1ColIdx);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucMemAddr1RowIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr1RowIdx);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucMemAddr2ColIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr2ColIdx);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucMemAddr2RowIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr2RowIdx);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucMemAddr2RowIdxMsb= %d\n",
	       prPfmuTag1->rField.ucMemAddr2RowIdxMsb);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucMemAddr3ColIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr3ColIdx);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucMemAddr3RowIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr3RowIdx);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucMemAddr4ColIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr4ColIdx);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucMemAddr4RowIdx= %d\n",
	       prPfmuTag1->rField.ucMemAddr4RowIdx);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucReserved= %d\n", prPfmuTag1->rField.ucReserved);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucNrow= %d\n", prPfmuTag1->rField.ucNrow);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucNcol= %d\n", prPfmuTag1->rField.ucNcol);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucNgroup= %d\n", prPfmuTag1->rField.ucNgroup);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucLM= %d\n", prPfmuTag1->rField.ucLM);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucCodeBook= %d\n", prPfmuTag1->rField.ucCodeBook);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucHtcExist= %d\n", prPfmuTag1->rField.ucHtcExist);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucReserved1= %d\n", prPfmuTag1->rField.ucReserved1);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucSNR_STS0= %d\n", prPfmuTag1->rField.ucSNR_STS0);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucSNR_STS1= %d\n", prPfmuTag1->rField.ucSNR_STS1);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucSNR_STS2= %d\n", prPfmuTag1->rField.ucSNR_STS2);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucSNR_STS3= %d\n", prPfmuTag1->rField.ucSNR_STS3);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag1 : prPfmuTag1->rField.ucIBfLnaIdx= %d\n", prPfmuTag1->rField.ucIBfLnaIdx);

	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag2 : prPfmuTag2->rField.u2SmartAnt = %d\n", prPfmuTag2->rField.u2SmartAnt);
	DBGLOG(INIT, ERROR,
		"MT6632 prPfmuTag2 : prPfmuTag2->rField.ucReserved0 = %d\n", prPfmuTag2->rField.ucReserved0);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag2 : prPfmuTag2->rField.ucSEIdx = %d\n", prPfmuTag2->rField.ucSEIdx);
	DBGLOG(INIT, ERROR, "MT6632 prPfmuTag2 : prPfmuTag2->rField.ucRMSDThd = %d\n", prPfmuTag2->rField.ucRMSDThd);
	DBGLOG(INIT, ERROR,
...
INT_32 TxBfProfileTagRead(struct net_device *prNetDev, UINT_8 profileIdx, UINT_8 fgBFer)
{
	...
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileTagRead : profileIdx = 0x%08x\n", profileIdx);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileTagRead : fgBFer = 0x%08x\n", fgBFer);
...
)
{
	...
	DBGLOG(INIT, ERROR, "ucWlanId = 0x%08x\n", ucWlanId);
			   ...
			   UINT_8 profileIdx, UINT_8 fgBFer, UINT_8 ucSubCarrIdxMsb, UINT_8 ucSubCarrIdxLsb)
{
	...
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataRead : ucPfmuIdx = 0x%08x\n", profileIdx);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataRead : fgBFer = 0x%08x\n", fgBFer);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataRead : ucSubCarrIdxMsb = 0x%08x\n", ucSubCarrIdxMsb);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataRead : ucSubCarrIdxLsb = 0x%08x\n", ucSubCarrIdxLsb);
...
)
{
	...
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : ucPfmuIdx = 0x%08x\n", profileIdx);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : u2SubCarrIdx = 0x%08x\n", u2SubCarrIdx);

	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : au2Phi[0] = 0x%08x\n", au2Phi[0]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : au2Phi[1] = 0x%08x\n", au2Phi[1]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : au2Phi[2] = 0x%08x\n", au2Phi[2]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : au2Phi[3] = 0x%08x\n", au2Phi[3]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : au2Phi[4] = 0x%08x\n", au2Phi[4]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : au2Phi[5] = 0x%08x\n", au2Phi[5]);

	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : aucPsi[0] = 0x%08x\n", aucPsi[0]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : aucPsi[1] = 0x%08x\n", aucPsi[1]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : aucPsi[2] = 0x%08x\n", aucPsi[2]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : aucPsi[3] = 0x%08x\n", aucPsi[3]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : aucPsi[4] = 0x%08x\n", aucPsi[4]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : aucPsi[5] = 0x%08x\n", aucPsi[5]);

	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : aucDSnr[0] = 0x%x\n", aucDSnr[0]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : aucDSnr[1] = 0x%x\n", aucDSnr[1]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : aucDSnr[2] = 0x%x\n", aucDSnr[2]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfileDataWrite : aucDSnr[3] = 0x%x\n", aucDSnr[3]);
...
INT_32 TxBfProfilePnRead(struct net_device *prNetDev, UINT_8 profileIdx)
{
	...
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnRead : ucPfmuIdx = 0x%08x\n", profileIdx);
...
INT_32 TxBfProfilePnWrite(struct net_device *prNetDev, UINT_8 profileIdx, UINT_16 u2bw, UINT_16 au2XSTS[12])
{
	...
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnWrite : ucPfmuIdx = 0x%08x\n", profileIdx);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnWrite : u2bw = 0x%08x\n", u2bw);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnWrite : au2XSTS[0] = 0x%08x\n", au2XSTS[0]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnWrite : au2XSTS[1] = 0x%08x\n", au2XSTS[1]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnWrite : au2XSTS[2] = 0x%08x\n", au2XSTS[2]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnWrite : au2XSTS[3] = 0x%08x\n", au2XSTS[3]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnWrite : au2XSTS[4] = 0x%08x\n", au2XSTS[4]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnWrite : au2XSTS[5] = 0x%08x\n", au2XSTS[5]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnWrite : au2XSTS[6] = 0x%08x\n", au2XSTS[6]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnWrite : au2XSTS[7] = 0x%08x\n", au2XSTS[7]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnWrite : au2XSTS[8] = 0x%08x\n", au2XSTS[8]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnWrite : au2XSTS[9] = 0x%08x\n", au2XSTS[9]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnWrite : au2XSTS[10] = 0x%08x\n", au2XSTS[10]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfProfilePnWrite : au2XSTS[11] = 0x%08x\n", au2XSTS[11]);
...
)
{
	...
	DBGLOG(INIT, ERROR, "MT6632 TxBfSounding : ucSuMu = 0x%08x\n", ucSuMu);
	DBGLOG(INIT, ERROR, "MT6632 TxBfSounding : ucNumSta = 0x%08x\n", ucNumSta);
	DBGLOG(INIT, ERROR, "MT6632 TxBfSounding : ucSndInterval = 0x%08x\n", ucSndInterval);
	DBGLOG(INIT, ERROR, "MT6632 TxBfSounding : ucWLan0 = 0x%08x\n", ucWLan0);
	DBGLOG(INIT, ERROR, "MT6632 TxBfSounding : ucWLan1 = 0x%08x\n", ucWLan1);
	DBGLOG(INIT, ERROR, "MT6632 TxBfSounding : ucWLan2 = 0x%08x\n", ucWLan2);
	DBGLOG(INIT, ERROR, "MT6632 TxBfSounding : ucWLan3 = 0x%08x\n", ucWLan3);
...
INT_32 TxBfSoundingStop(struct net_device *prNetDev)
{
	...
	DBGLOG(INIT, ERROR, "MT6632 TxBfSoundingStop\n");
...
INT_32 TxBfPfmuMemRelease(struct net_device *prNetDev, UINT_8 ucWlanId)
{
	...
	DBGLOG(INIT, ERROR, "MT6632 TxBfPfmuMemRelease : ucWlanId = 0x%08x\n", ucWlanId);
...
INT_32 TxBfBssInfoUpdate(struct net_device *prNetDev, UINT_8 ucOwnMacIdx, UINT_8 ucBssIdx, UINT_8 ucBssId[MAC_ADDR_LEN])
{
	...
	DBGLOG(INIT, ERROR, "MT6632 TxBfBssInfoUpdate : ucOwnMacIdx = 0x%08x\n", ucOwnMacIdx);
	DBGLOG(INIT, ERROR, "MT6632 TxBfBssInfoUpdate : ucBssIdx = 0x%08x\n", ucBssIdx);
	DBGLOG(INIT, ERROR, "MT6632 TxBfBssInfoUpdate : ucBssId[0] = 0x%08x\n", ucBssId[0]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfBssInfoUpdate : ucBssId[1] = 0x%08x\n", ucBssId[1]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfBssInfoUpdate : ucBssId[2] = 0x%08x\n", ucBssId[2]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfBssInfoUpdate : ucBssId[3] = 0x%08x\n", ucBssId[3]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfBssInfoUpdate : ucBssId[4] = 0x%08x\n", ucBssId[4]);
	DBGLOG(INIT, ERROR, "MT6632 TxBfBssInfoUpdate : ucBssId[5] = 0x%08x\n", ucBssId[5]);
