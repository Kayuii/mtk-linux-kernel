...
typedef struct _CMD_EFUSE_BUFFER_MODE_T {
	...
	UINT_8 ucCount;
	UINT_8 ucReserved[2];
	UINT_8 aBinContent[EFUSE_CONTENT_SIZE];
...
typedef enum _ENUM_EVENT_ID_T {
	...
	EVENT_ID_PFMU_TAG_READ = 0x30,
	EVENT_ID_PFMU_DATA_READ = 0x31,
#endif /* CFG_SUPPORT_TX_BF */
#if CFG_SUPPORT_MU_MIMO
	EVENT_ID_MU_GET_QD = 0x32,
#endif /* CFG_SUPPORT_MU_MIMO */
...
typedef struct _CMD_ACCESS_REG {
	...
	UINT_32 u4Data;
#if CFG_SUPPORT_QA_TOOL
	UINT_8 ucAntIdx;	/* PeiHsuan 6632 : CR Read / Write with Antenna Idx */
	UINT_8 ucReserved[3];	/* PeiHsuan 6632 : CR Read / Write with Antenna Idx */
#endif				/* CFG_SUPPORT_QA_TOOL */
...
typedef struct _CMD_SCAN_REQ_V2_T {
	...
	CHANNEL_INFO_T arChannelListExtend[32];
	UINT_8 arPerCannelControl[32];
	UINT_8 arPerExtendCannelControl[32];
