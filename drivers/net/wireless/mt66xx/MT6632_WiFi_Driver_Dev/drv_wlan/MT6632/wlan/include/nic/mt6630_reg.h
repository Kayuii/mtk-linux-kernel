...
/* RX Ring1 Control 0 */
#define WPDMA_RX_RING1_CTRL0			(PCIE_HIF_BASE + 0x0410)

/* RX Ring1 Control 1 */
#define WPDMA_RX_RING1_CTRL1			(PCIE_HIF_BASE + 0x0414)

/* RX Ring1 Control 2 */
#define WPDMA_RX_RING1_CTRL2			(PCIE_HIF_BASE + 0x0418)

/* RX Ring1 Control 3 */
#define WPDMA_RX_RING1_CTRL3			(PCIE_HIF_BASE + 0x041C)
...
/* WPDMA_INT_STA */
typedef union _WPDMA_INT_STA_STRUC {
	struct {
		UINT_32 rx_done_0:1;
		UINT_32 rx_done_1:1;
...
#define WIFI_TASK_STATE_INITIAL	            (0)
#define WIFI_TASK_STATE_FW_DOWNLOAD	        (1)
#define WIFI_TASK_STATE_NORMAL_OPERATION	(2)
