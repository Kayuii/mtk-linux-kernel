...
#ifndef _MT6632_REG_H
#define _MT6632_REG_H
...
typedef enum _ENUM_MTK_WIFI_CHIP_T {
	MTK_WIFI_CHIP_6632 = 0,
	MTK_WIFI_CHIP_7666,
	MTK_WIFI_CHIP_7668,
	MTK_WIFI_CHIP_MAX
} ENUM_MTK_WIFI_CHIP_T;

typedef struct _MTK_WIFI_CHIP_INFO_T {
	UINT_32 chip_id;	/* chip id */
	UINT_32 sw_sync0;	/* sw_sync0 address */
	UINT_32 sw_ready_bit_offset;	/* sw_sync0 ready bit offset */
} MTK_WIFI_CHIP_INFO_T, *P_MTK_WIFI_CHIP_INFO_T;
